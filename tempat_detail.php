...
<center><a href="#" class="s-link" data-link-text="<?=$row->nama_tempat?>">
    <span> <h1><?=$row->nama_tempat?></h1></span>
    </a></center>
</div>
    <div class="col-md-12">
        <center><p>
            <a href="?m=tempat_list" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-chevron-left"></span> Lihat semua tempat</a>
            <a href="javascript:void(0)" onclick="showRoute()" class="btn btn-success btn-sm"> <span class="glyphicon glyphicon-search"></span> Tampilkan Rute </a>
